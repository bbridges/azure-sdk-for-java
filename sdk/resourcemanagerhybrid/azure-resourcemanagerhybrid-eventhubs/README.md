...
[//]: # ({x-version-update-start;com.azure.resourcemanagerhybrid:azure-resourcemanagerhybrid-eventhubs;current})
```xml
<dependency>
    <groupId>com.azure.resourcemanagerhybrid</groupId>
    <artifactId>azure-resourcemanagerhybrid-eventhubs</artifactId>
