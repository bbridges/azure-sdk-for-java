# Azure Resource Manager monitor client library for Java (Hybrid)
...
[//]: # ({x-version-update-start;com.azure.resourcemanagerhybrid:azure-resourcemanagerhybrid-monitor;current})
```xml
<dependency>
    <groupId>com.azure.resourcemanagerhybrid</groupId>
    <artifactId>azure-resourcemanagerhybrid-monitor</artifactId>
