...
[//]: # ({x-version-update-start;com.azure.resourcemanagerhybrid:azure-resourcemanagerhybrid-containerservice;current})
```xml
<dependency>
    <groupId>com.azure.resourcemanagerhybrid</groupId>
    <artifactId>azure-resourcemanagerhybrid-containerservice</artifactId>
